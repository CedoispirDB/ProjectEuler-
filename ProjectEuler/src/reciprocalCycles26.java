        ...
        for (int d = 1; d <= 1000; d++) {
            ...
            if (1000 % d != 0) {
                ...
                if (!decimals.substring(25, 35).equals(decimals.substring(35, 45))) {
                    for (int l = 1; l <= decimals.length(); l++) {
                        ...
                        if (godKnows.equals(dust)) {
                            //tools.d("Is here." + " The number is " + d);
                            infinity = false;
                            break;
                        }
                    }
                ...
                if (!infinity) {
                    ...
                    //tools.d("The number " + d + " decimals in " + decimals.substring(0, 6) + "  and it is not infinity");
                    //tools.d(decimals);
                    lastOccurrence = decimals.lastIndexOf(decimals.substring(0, 5));
                    //tools.d("Last occurrence: " + lastOccurrence);
                    //tools.d("Original:" + decimals);
                    newDecimal = decimals.substring(0, lastOccurrence);
                    //tools.d("Reduced:" + decimals);
